...
public static class Seeder
{
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        if (!await db.AccessoryContracts.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            var acc = new AccessoryContract
            {
                OrgId = org,
                DlrContractPartNo = "PLHD202603-001",
                DlrCtrPartType = "PHUKIEN",
                ContractPartDate = DateTime.Now.AddDays(-2),
                DepositVal = 20000000m,
                UserCodeOwner = "TVBH-01",
                UserNameOwner = "Hoàng Minh",
                DealerCode = "DLR-HN01",
                BankAccountNo = "0071000123456",
                CustomerCode = "CUST-001",
                CustomerName = "Nguyễn Văn An",
                TotalValBeforeVAT = 45000000m,
                Status = "Approved",
                Remark = "Phụ lục hợp đồng phụ kiện chính hãng lắp kèm xe Accent cho khách hàng cá nhân",
                CreatedBy = "dealer.hn01",
                CreatedAt = DateTime.Now.AddDays(-2),
                ApprovedBy = "sales.director",
                ApprovedAt = DateTime.Now.AddDays(-1)
            };
            db.AccessoryContracts.Add(acc);
            await db.SaveChangesAsync();

            db.AccessoryContractLines.AddRange(
                new AccessoryContractLine
                {
                    OrgId = org,
                    AccessoryContractId = acc.Id,
                    DlrContractPartNo = acc.DlrContractPartNo,
                    PartCode = "ACC-CAM-360",
                    PartName = "Camera 360 độ toàn cảnh chính hãng",
                    PartUnitCode = "Bộ",
                    Qty = 1,
                    UnitPrice = 25000000m,
                    ValABeforeVAT = 25000000m,
                    Status = "Approved",
                    Remark = "Lắp đặt tại xưởng đại lý"
                },
                new AccessoryContractLine
                {
                    OrgId = org,
                    AccessoryContractId = acc.Id,
                    DlrContractPartNo = acc.DlrContractPartNo,
                    PartCode = "ACC-FLOOR-MAT",
                    PartName = "Thảm lót sàn cao cấp 5D",
                    PartUnitCode = "Bộ",
                    Qty = 1,
                    UnitPrice = 3500000m,
                    ValABeforeVAT = 3500000m,
                    Status = "Approved",
                    Remark = "Phụ kiện tặng kèm"
                },
                new AccessoryContractLine
                {
                    OrgId = org,
                    AccessoryContractId = acc.Id,
                    DlrContractPartNo = acc.DlrContractPartNo,
                    PartCode = "ACC-FILM-3M",
                    PartName = "Dán phim cách nhiệt 3M toàn xe",
                    PartUnitCode = "Bộ",
                    Qty = 1,
                    UnitPrice = 16500000m,
                    ValABeforeVAT = 16500000m,
                    Status = "Approved",
                    Remark = "Bảo hành 5 năm"
                }
            );
        }

        if (!await db.SalesProcesses.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            var sp = new SalesProcess
            {
                OrgId = org,
                SalesID = "SP202603-001",
                CustomerCode = "CUST-001",
                CustomerTypeCode = "Individual",
                DealerCode = "DLR-HN01",
                UserCodeOwner = "TVBH-01",
                CampaignCode = "MKT-2026-03",
                BudgetVal = 750000m,
                CarModelType = "SUV",
                ContractExpectedDate = DateTime.Now.AddDays(20),
                SPLevelCode = "3",
                SPLevelStatus = "A",
                SPLevelDTime = DateTime.Now.AddDays(-1),
                SPLevelBy = "sales.manager",
                SPStatus = "DAMPHAN",
                Remark = "Khách quan tâm Tucson, đang đàm phán giá và phụ kiện",
                CreatedBy = "dealer.hn01",
                CreatedAt = DateTime.Now.AddDays(-6)
            };
            ...
            db.SalesProcessLines.AddRange(
                new SalesProcessLine
                {
                    OrgId = org,
                    ...
                    Qty = 1,
                    SPStatusDtl = "DAMPHAN",
                    Remark = "Khách ưu tiên bản đặc biệt"
                },
                new SalesProcessLine
                {
                    OrgId = org,
                    ...
                    ModelCode = "SANTAFE",
                    ColorCode = "DEN",
                    SpecCode = "2.2D Signature",
                    Qty = 1,
                    SPStatusDtl = "DAMPHAN",
                    Remark = "Phương án dự phòng nếu ngân sách tăng"
                }
            );
            ...
            db.SalesProcessKpis.Add(new SalesProcessKpi
            {
                ...
                Remark = "Ghi nhận khách hàng mới quan tâm"
            });
        }

        if (!await db.HtmvPdis.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            var pdi = new HtmvPdi
            {
                ...
                PDINo = "PDI202603-001",
                Status = "P",
                Remark = "Đề nghị nhận lô xe Accent xuất xưởng nhà máy HTMV Ninh Bình",
                CreatedBy = "plan.htmv",
                CreatedAt = DateTime.Now.AddDays(-3)
            };
            db.HtmvPdis.Add(pdi);
            ...
            db.HtmvPdiDtls.AddRange(
                new HtmvPdiDtl
                {
                    ...
                    PDIStorageStatus = "P",
                    PdiResult = "Pending",
                    Remark = "Xe chờ kiểm PDI xuất xưởng"
                },
                new HtmvPdiDtl
                {
                    OrgId = org,
        ...
        if (!await db.RearrangeTransportRequests.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            var srt = new RearrangeTransportRequest
            {
                OrgId = org,
                SRTReqNo = "SRT202603-001",
                TransporterCode = "NYK",
                TransportContractNo = "HDVT-2026/NYK-089",
                TruckPlateNo = "29C-928.34",
                DriverName = "Vũ Mạnh Hùng",
                DriverPhone = "0912345678",
                FromStorage = "YARD-A1",
                ToStorage = "YARD-C1",
                EstimatedDeparture = DateTime.Now.AddDays(1),
                EstimatedArrival = DateTime.Now.AddDays(2),
                Status = "P",
                Remark = "Điều chuyển lại vận chuyển lô xe Accent & Creta sang bãi C1 theo kế hoạch điều độ tháng 03/2026",
                CreatedBy = "logistic.planner",
                CreatedAt = DateTime.Now.AddHours(-6)
            };
            db.RearrangeTransportRequests.Add(srt);
            await db.SaveChangesAsync();

            db.RearrangeTransportRequestLines.AddRange(
                new RearrangeTransportRequestLine
                {
                    OrgId = org,
                    RearrangeTransportRequestId = srt.Id,
                    SRTReqNo = srt.SRTReqNo,
                    Vin = "DEMOVIN00000001",
                    StorageRearrangeNo = "SRR202603-001",
                    StorageCodeFrom = "YARD-A1",
                    StorageCodeTo = "YARD-C1",
                    Status = "P",
                    Remark = "Xe Accent chuyển bãi C1"
                },
                new RearrangeTransportRequestLine
                {
                    OrgId = org,
                    ...
                    Vin = "DEMOVIN00000002",
                    StorageRearrangeNo = "SRR202603-001",
                    StorageCodeFrom = "YARD-B2",
                    StorageCodeTo = "YARD-C1",
                    Status = "P",
                    Remark = "Xe Creta chuyển bãi C1"
                }
            );
        }

        if (!await db.CarPlans.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            var cp = new CarPlan
            {
                ...
                Status = "Approved",
                CreatedBy = "dealer.hn01",
                ApprovedBy = "plan.manager",
                ApprovedAt = DateTime.Now.AddDays(-3),
                Remark = "Kế hoạch xe về tháng 03/2026 đại lý Hà Nội 01"
            };
            db.CarPlans.Add(cp);
            await db.SaveChangesAsync();

            db.CarPlanLines.AddRange(
                new CarPlanLine
                {
                    OrgId = org,
                    CarPlanId = cp.Id,
        ...
        if (!await db.StorageGlobals.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            db.StorageGlobals.AddRange(
                new StorageGlobal { OrgId = org, StorageCode = "YARD-A1", ModelCode = "ACCENT", FlagActive = true, LogLUDateTime = DateTime.Now, LogLUBy = "planner.oem" },
                new StorageGlobal { OrgId = org, StorageCode = "YARD-B2", ModelCode = "CRETA", FlagActive = true, LogLUDateTime = DateTime.Now, LogLUBy = "planner.oem" },
                new StorageGlobal { OrgId = org, StorageCode = "BODY-SHOP-01", ModelCode = "PORTER", FlagActive = true, LogLUDateTime = DateTime.Now, LogLUBy = "planner.oem" }
            );
        }

        if (!await db.StorageLocals.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            db.StorageLocals.AddRange(
                new StorageLocal { OrgId = org, DealerCode = "DLR-HN01", StorageCode = "DLR-YARD-01", FlagActive = true, LogLUDateTime = DateTime.Now, LogLUBy = "dealer.hn01" },
                new StorageLocal { OrgId = org, DealerCode = "DLR-HN01", StorageCode = "DLR-SHOWROOM", FlagActive = true, LogLUDateTime = DateTime.Now, LogLUBy = "dealer.hn01" }
            );
        }

        if (!await db.CarPriceInStocks.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            var eff = DateTime.Now.Date;
            db.CarPriceInStocks.AddRange(
                new CarPriceInStock { OrgId = org, SpecCode = "ACCENT-1.4AT", EffectiveDate = eff, UnitPriceIn = 480000000m, CreatedBy = "planner.oem", LogLUDateTime = DateTime.Now, LogLUBy = "planner.oem" },
                new CarPriceInStock { OrgId = org, SpecCode = "CRETA-1.5AT", EffectiveDate = eff, UnitPriceIn = 620000000m, CreatedBy = "planner.oem", LogLUDateTime = DateTime.Now, LogLUBy = "planner.oem" },
                new CarPriceInStock { OrgId = org, SpecCode = "PORTER-H150", EffectiveDate = eff, UnitPriceIn = 350000000m, CreatedBy = "planner.oem", LogLUDateTime = DateTime.Now, LogLUBy = "planner.oem" }
            );
        }

        if (!await db.VehicleDevices.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            db.VehicleDevices.AddRange(
                new VehicleDevice { OrgId = org, Vin = "DEMOVIN00001", DeviceTypeCode = "AVN", SpecCode = "1.4 AT Đặc biệt", ModelCode = "ACCENT", ColorCode = "WHT", InputInvoiceNo = "HDDT-AVN-202603-001", InputInvoiceDate = DateTime.Now.AddDays(-4), LogLUDateTime = DateTime.Now, LogLUBy = "wh.oem" },
                new VehicleDevice { OrgId = org, Vin = "DEMOVIN00001", DeviceTypeCode = "GPS", SpecCode = "1.4 AT Đặc biệt", ModelCode = "ACCENT", ColorCode = "WHT", InputInvoiceNo = "HDDT-GPS-202603-001", InputInvoiceDate = DateTime.Now.AddDays(-4), LogLUDateTime = DateTime.Now, LogLUBy = "wh.oem" },
                new VehicleDevice { OrgId = org, Vin = "DEMOVIN00002", DeviceTypeCode = "AVN", SpecCode = "1.5 Cao cấp 2 tông màu", ModelCode = "CRETA", ColorCode = "BLK", InputInvoiceNo = "HDDT-AVN-202603-002", InputInvoiceDate = DateTime.Now.AddDays(-3), LogLUDateTime = DateTime.Now, LogLUBy = "wh.oem" },
                new VehicleDevice { OrgId = org, Vin = "DEMOVIN00002", DeviceTypeCode = "CAMERA", SpecCode = "1.5 Cao cấp 2 tông màu", ModelCode = "CRETA", ColorCode = "BLK", InputInvoiceNo = null, InputInvoiceDate = null, LogLUDateTime = DateTime.Now, LogLUBy = "wh.oem" }
            );
        }
        ...
        if (!await db.DealerContractForms.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            db.DealerContractForms.AddRange(
                new DealerContractForm { OrgId = org, ContractFNo = "HDBL-RETAIL", ContractFName = "Mẫu hợp đồng mua bán xe bán lẻ (cá nhân)", ContractFType = "Retail", FlagActive = "1", Remark = "Mẫu hợp đồng bán lẻ xe cho khách hàng cá nhân", LogLUDateTime = DateTime.Now, LogLUBy = "admin.oem" },
                new DealerContractForm { OrgId = org, ContractFNo = "HDBL-WHOLESALE", ContractFName = "Mẫu hợp đồng mua bán xe bán buôn (đại lý)", ContractFType = "Wholesale", FlagActive = "1", Remark = "Mẫu hợp đồng bán buôn lô xe cho đại lý phân phối", LogLUDateTime = DateTime.Now, LogLUBy = "admin.oem" }
            );
            await db.SaveChangesAsync();
        }

        if (!await db.DealerContractFormTerms.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            db.DealerContractFormTerms.AddRange(
                new DealerContractFormTerm
                {
                    OrgId = org, DealerCode = "DLR-HN01", ContractFNo = "HDBL-RETAIL",
                    Note = "Áp dụng cho hợp đồng bán lẻ xe Accent & Creta tại showroom Hà Nội 01",
                    Promotion = "Tặng gói phụ kiện chính hãng trị giá 15.000.000đ khi thanh toán 100%",
                    TimePayment = "Trong vòng 07 ngày kể từ ngày ký hợp đồng",
                    MethodPayment = "Tiền mặt / Chuyển khoản / Trả góp ngân hàng",
                    TimeAndAddressDelivery = "Giao xe trong 15 ngày tại showroom đại lý Hà Nội 01",
                    TimeOwnerTransfer = "Trong vòng 30 ngày kể từ ngày bàn giao xe",
                    RightAndResponsibilityPartySeller = "Bên bán chịu trách nhiệm về nguồn gốc, chất lượng xe và hồ sơ pháp lý",
                    RightAndResponsibilityPartyBuyer = "Bên mua thanh toán đầy đủ, đúng hạn và nhận xe theo thỏa thuận",
                    Warrantly = "Bảo hành chính hãng 36 tháng hoặc 100.000 km tùy điều kiện nào đến trước",
                    OtherTerms = "Mọi tranh chấp giải quyết theo pháp luật Việt Nam",
                    FlagActive = "1", CreateBy = "dealer.hn01", LogLUDateTime = DateTime.Now, LogLUBy = "dealer.hn01"
                },
                new DealerContractFormTerm
                {
                    OrgId = org, DealerCode = "DLR-HN01", ContractFNo = "HDBL-WHOLESALE",
                    Note = "Áp dụng cho hợp đồng bán buôn lô xe cho đại lý Hà Nội 01",
                    Promotion = "Chiết khấu thanh toán trả sớm 1.5% theo chính sách tháng",
                    TimePayment = "Trong vòng 30 ngày kể từ ngày xuất hóa đơn",
                    MethodPayment = "Bảo lãnh ngân hàng / Chuyển khoản",
                    TimeAndAddressDelivery = "Giao xe tại kho OEM hoặc đại lý theo lịch điều vận",
                    TimeOwnerTransfer = "Sau khi đại lý thanh toán đủ 100% giá trị lô xe",
                    RightAndResponsibilityPartySeller = "Bên bán giao đủ số lượng, chủng loại xe theo hợp đồng",
                    RightAndResponsibilityPartyBuyer = "Bên mua nhận xe và thanh toán theo tiến độ thỏa thuận",
                    Warrantly = "Bảo hành chính hãng theo tiêu chuẩn OEM",
                    OtherTerms = "Điều khoản phạt vi phạm và bồi thường theo hợp đồng khung",
                    FlagActive = "1", CreateBy = "dealer.hn01", LogLUDateTime = DateTime.Now, LogLUBy = "dealer.hn01"
                }
            );
        }

        if (!await db.UserSchedules.AnyAsync())
        {
            var org = TenantContext.DefaultOrgId;
            db.UserSchedules.AddRange(
                new UserSchedule
                {
                    OrgId = org, SchCode = "SCH-202603-001", UserCodeOwner = "tvvb.hn01",
                    KPIPlusCode = "KPI_RETAIL_DELIVERY", KPIPlusName = "Bàn giao xe bán lẻ cho khách",
                    SalesID = "SP-202603-001", SchLocation = "Showroom Hà Nội 01",
                    EffDTimeStart = DateTime.Now.Date.AddHours(8), EffDTimeEnd = DateTime.Now.Date.AddHours(17),
                    RankingType = "GOOD", LevelType = "HIGH", CustomerCode = "CUS-HN01-001",
                    Remark = "Tư vấn bán hàng & bàn giao xe Accent cho khách hàng",
                    USStatus = "P", CreateBy = "tvvb.hn01", CreatedAt = DateTime.Now,
                    LUDTime = DateTime.Now, LUBy = "tvvb.hn01", LogLUDateTime = DateTime.Now, LogLUBy = "tvvb.hn01"
                },
                new UserSchedule
                {
                    OrgId = org, SchCode = "SCH-202603-002", UserCodeOwner = "cvdv.hn01",
                    KPIPlusCode = "KPI_SERVICE_APPOINTMENT", KPIPlusName = "Tiếp nhận lịch hẹn dịch vụ",
                    SchLocation = "Xưởng dịch vụ Hà Nội 01",
                    EffDTimeStart = DateTime.Now.Date.AddHours(8), EffDTimeEnd = DateTime.Now.Date.AddHours(17),
                    RankingType = "LOW", LevelType = "MEDIUM",
                    Remark = "Tiếp nhận xe bảo dưỡng định kỳ",
                    USStatus = "A", CreateBy = "cvdv.hn01", CreatedAt = DateTime.Now,
                    LUDTime = DateTime.Now, LUBy = "manager.hn01", LogLUDateTime = DateTime.Now, LogLUBy = "manager.hn01"
                }
            );
        }
    ...
    private static async Task MigrateAsync(AppDbContext db)
    {
        ...
        var stmts = new[]
        {
            ...
            "CREATE TABLE IF NOT EXISTS public.\"DocRequestLists\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"DRListCode\" text NOT NULL DEFAULT '', \"TypeCRR\" text NOT NULL DEFAULT 'NORMAL', \"DealerCode\" text NULL, \"Status\" text NOT NULL DEFAULT 'Pending', \"Remark\" text NULL, \"CreatedBy\" text NULL, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"ApprovedBy1\" text NULL, \"ApprovedAt1\" timestamp NULL, \"ApprovedBy2\" text NULL, \"ApprovedAt2\" timestamp NULL, \"CancelledBy\" text NULL, \"CancelledAt\" timestamp NULL, \"CancelReason\" text NULL)",
            "CREATE TABLE IF NOT EXISTS public.\"DocRequestListLines\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"DocRequestListId\" bigint NOT NULL, \"DRListCode\" text NOT NULL DEFAULT '', \"LineIndex\" integer NOT NULL DEFAULT 1, \"Vin\" text NOT NULL DEFAULT '', \"Model\" text NULL, \"EngineNo\" text NULL, \"Color\" text NULL, \"DealerCode\" text NULL, \"Status\" text NOT NULL DEFAULT 'Pending', \"Remark\" text NULL, \"ApprovedBy1\" text NULL, \"ApprovedAt1\" timestamp NULL, \"ApprovedBy2\" text NULL, \"ApprovedAt2\" timestamp NULL, \"RejectedBy\" text NULL, \"RejectedAt\" timestamp NULL, \"CancelledBy\" text NULL, \"CancelledAt\" timestamp NULL)",
            "CREATE TABLE IF NOT EXISTS public.\"AccessoryContracts\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"DlrContractPartNo\" text NOT NULL DEFAULT '', \"DlrCtrPartType\" text NOT NULL DEFAULT 'PHUKIEN', \"ContractPartDate\" timestamp NULL, \"DepositVal\" numeric NOT NULL DEFAULT 0, \"UserCodeOwner\" text NULL, \"UserNameOwner\" text NULL, \"DealerCode\" text NOT NULL DEFAULT '', \"BankAccountNo\" text NULL, \"CustomerCode\" text NULL, \"CustomerName\" text NULL, \"TotalValBeforeVAT\" numeric NOT NULL DEFAULT 0, \"Status\" text NOT NULL DEFAULT 'Pending', \"Remark\" text NULL, \"CreatedBy\" text NULL, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"ApprovedBy\" text NULL, \"ApprovedAt\" timestamp NULL, \"CancelledBy\" text NULL, \"CancelledAt\" timestamp NULL)",
            "CREATE TABLE IF NOT EXISTS public.\"AccessoryContractLines\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"AccessoryContractId\" bigint NOT NULL, \"DlrContractPartNo\" text NOT NULL DEFAULT '', \"PartCode\" text NOT NULL DEFAULT '', \"PartName\" text NULL, \"PartUnitCode\" text NULL, \"Qty\" numeric NOT NULL DEFAULT 1, \"UnitPrice\" numeric NOT NULL DEFAULT 0, \"ValABeforeVAT\" numeric NOT NULL DEFAULT 0, \"Status\" text NOT NULL DEFAULT 'Pending', \"Remark\" text NULL)",
            "CREATE TABLE IF NOT EXISTS public.\"SalesProcesses\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"SalesID\" text NOT NULL DEFAULT '', \"CustomerCode\" text NULL, \"CustomerTypeCode\" text NULL, \"DealerCode\" text NOT NULL DEFAULT '', \"UserCodeOwner\" text NULL, \"CampaignCode\" text NULL, \"BudgetVal\" numeric NOT NULL DEFAULT 0, \"CarModelType\" text NOT NULL DEFAULT '', \"ContractExpectedDate\" timestamp NULL, \"SPLevelCode\" text NOT NULL DEFAULT '0', \"SPLevelStatus\" text NOT NULL DEFAULT 'P', \"SPLevelDTime\" timestamp NULL, \"SPLevelBy\" text NULL, \"SPStatus\" text NOT NULL DEFAULT 'THAMKHAO', \"Remark\" text NULL, \"CreatedBy\" text NULL, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"UpdatedAt\" timestamp NULL, \"UpdatedBy\" text NULL)",
            "CREATE TABLE IF NOT EXISTS public.\"SalesProcessLines\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"SalesProcessId\" bigint NOT NULL, \"SalesID\" text NOT NULL DEFAULT '', \"ModelCode\" text NOT NULL DEFAULT '', \"ColorCode\" text NULL, \"SpecCode\" text NULL, \"Qty\" integer NOT NULL DEFAULT 1, \"SPStatusDtl\" text NOT NULL DEFAULT 'THAMKHAO', \"Remark\" text NULL)",
            "CREATE TABLE IF NOT EXISTS public.\"SalesProcessKpis\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"SalesProcessId\" bigint NOT NULL, \"SalesID\" text NOT NULL DEFAULT '', \"KPICode\" text NOT NULL DEFAULT '', \"CreatedDate\" timestamp NULL, \"Remark\" text NULL)",
            "CREATE TABLE IF NOT EXISTS public.\"HtmvPdis\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"PDINo\" text NOT NULL DEFAULT '', \"Status\" text NOT NULL DEFAULT 'P', \"Remark\" text NULL, \"CreatedBy\" text NULL, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"ApprovedBy\" text NULL, \"ApprovedAt\" timestamp NULL)",
            "CREATE TABLE IF NOT EXISTS public.\"HtmvPdiDtls\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"HtmvPdiId\" bigint NOT NULL, \"PDINo\" text NOT NULL DEFAULT '', \"VIN\" text NOT NULL DEFAULT '', \"RefNo\" text NULL, \"LCTemp\" text NULL, \"SpecCode\" text NULL, \"ModelCode\" text NULL, \"ColorCode\" text NULL, \"ProductionMonth\" text NULL, \"EngineNo\" text NULL, \"PDIDtlStatus\" text NOT NULL DEFAULT 'P', \"PDIStorageStatus\" text NOT NULL DEFAULT 'P', \"PdiResult\" text NOT NULL DEFAULT 'Pending', \"FlagRepair\" text NULL, \"RepairRemark\" text NULL, \"PDIDate\" timestamp NULL, \"Remark\" text NULL, \"ApprovedBy\" text NULL, \"ApprovedAt\" timestamp NULL, \"CreatedAt\" timestamp NOT NULL DEFAULT now())",
            ...
            "CREATE TABLE IF NOT EXISTS public.\"CarPlans\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"CPCode\" text NOT NULL DEFAULT '', \"DealerCode\" text NOT NULL DEFAULT '', \"OrderNo\" text NULL, \"PlanMonth\" text NULL, \"TotalQtyOrder\" integer NOT NULL DEFAULT 0, \"TotalQty\" integer NOT NULL DEFAULT 0, \"TotalArrivedQty\" integer NOT NULL DEFAULT 0, \"TotalPendingQty\" integer NOT NULL DEFAULT 0, \"Status\" text NOT NULL DEFAULT 'Draft', \"CreatedBy\" text NULL, \"ApprovedBy\" text NULL, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"ApprovedAt\" timestamp NULL, \"CompletedAt\" timestamp NULL, \"Remark\" text NULL)",
            "CREATE TABLE IF NOT EXISTS public.\"CarPlanLines\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"CarPlanId\" bigint NOT NULL, \"CPCode\" text NOT NULL DEFAULT '', \"Model\" text NOT NULL DEFAULT '', \"SpecCode\" text NULL, \"Color\" text NULL, \"QtyOrder\" integer NOT NULL DEFAULT 0, \"Qty\" integer NOT NULL DEFAULT 0, \"ArrivedQty\" integer NOT NULL DEFAULT 0, \"PendingQty\" integer NOT NULL DEFAULT 0, \"Status\" text NOT NULL DEFAULT 'Pending', \"Remark\" text NULL)",
            "CREATE TABLE IF NOT EXISTS public.\"StorageGlobals\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"StorageCode\" text NOT NULL DEFAULT '', \"ModelCode\" text NOT NULL DEFAULT '', \"FlagActive\" boolean NOT NULL DEFAULT true, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"LogLUDateTime\" timestamp NULL, \"LogLUBy\" text NULL)",
            "CREATE UNIQUE INDEX IF NOT EXISTS \"IX_StorageGlobals_Org_Storage_Model\" ON public.\"StorageGlobals\" (\"OrgId\", \"StorageCode\", \"ModelCode\")",
            "CREATE TABLE IF NOT EXISTS public.\"StorageLocals\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"DealerCode\" text NOT NULL DEFAULT '', \"StorageCode\" text NOT NULL DEFAULT '', \"FlagActive\" boolean NOT NULL DEFAULT true, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"LogLUDateTime\" timestamp NULL, \"LogLUBy\" text NULL)",
            "CREATE UNIQUE INDEX IF NOT EXISTS \"IX_StorageLocals_Org_Dealer_Storage\" ON public.\"StorageLocals\" (\"OrgId\", \"DealerCode\", \"StorageCode\")",
            "CREATE TABLE IF NOT EXISTS public.\"CarPriceInStocks\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"SpecCode\" text NOT NULL DEFAULT '', \"EffectiveDate\" timestamp NOT NULL DEFAULT now(), \"UnitPriceIn\" numeric NOT NULL DEFAULT 0, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"CreatedBy\" text NULL, \"LogLUDateTime\" timestamp NULL, \"LogLUBy\" text NULL)",
            "CREATE UNIQUE INDEX IF NOT EXISTS \"IX_CarPriceInStocks_Org_Spec_Eff\" ON public.\"CarPriceInStocks\" (\"OrgId\", \"SpecCode\", \"EffectiveDate\")",
            "CREATE INDEX IF NOT EXISTS \"IX_CarPriceInStocks_Org_Spec\" ON public.\"CarPriceInStocks\" (\"OrgId\", \"SpecCode\")",
            ...
            "CREATE TABLE IF NOT EXISTS public.\"FnExpCalcs\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"CaNo\" text NOT NULL DEFAULT '', \"DealerCode\" text NOT NULL DEFAULT '', \"TermFrom\" timestamp NULL, \"TermTo\" timestamp NULL, \"TermPrevFrom\" timestamp NULL, \"TermPrevTo\" timestamp NULL, \"FnExpPercent\" numeric NOT NULL DEFAULT 0, \"PmtDsTCGPercent\" numeric NOT NULL DEFAULT 0, \"TotalFnDepositAmount\" numeric NOT NULL DEFAULT 0, \"TotalFnGrtAmount\" numeric NOT NULL DEFAULT 0, \"TotalFnAmount\" numeric NOT NULL DEFAULT 0, \"TotalPDAmount\" numeric NOT NULL DEFAULT 0, \"TotalVinCount\" integer NOT NULL DEFAULT 0, \"DlrSignStatus\" text NOT NULL DEFAULT 'P', \"HTCSignStatus\" text NOT NULL DEFAULT 'P', \"FnExpStatus\" text NOT NULL DEFAULT 'NS', \"DlrAppr1By\" text NULL, \"DlrAppr1At\" timestamp NULL, \"DlrAppr2By\" text NULL, \"DlrAppr2At\" timestamp NULL, \"HTCAppr1By\" text NULL, \"HTCAppr1At\" timestamp NULL, \"HTCAppr2By\" text NULL, \"HTCAppr2At\" timestamp NULL, \"CancelBy\" text NULL, \"CancelAt\" timestamp NULL, \"CancelReason\" text NULL, \"Remark\" text NULL, \"CreatedBy\" text NULL, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"LogLUDateTime\" timestamp NULL, \"LogLUBy\" text NULL)",
            "CREATE UNIQUE INDEX IF NOT EXISTS \"IX_FnExpCalcs_Org_CaNo\" ON public.\"FnExpCalcs\" (\"OrgId\", \"CaNo\")",
            "CREATE INDEX IF NOT EXISTS \"IX_FnExpCalcs_Org_Dealer\" ON public.\"FnExpCalcs\" (\"OrgId\", \"DealerCode\")",
            "CREATE INDEX IF NOT EXISTS \"IX_FnExpCalcs_Org_Status\" ON public.\"FnExpCalcs\" (\"OrgId\", \"FnExpStatus\")",
            "CREATE TABLE IF NOT EXISTS public.\"FnExpCalcLines\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"FnExpCalcId\" bigint NOT NULL, \"CaNo\" text NOT NULL DEFAULT '', \"Vin\" text NOT NULL DEFAULT '', \"CarId\" text NULL, \"ModelCode\" text NULL, \"SpecCode\" text NULL, \"AssemblyStatus\" text NOT NULL DEFAULT 'CBU', \"UnitPriceActual\" numeric NOT NULL DEFAULT 0, \"SOCode\" text NULL, \"SPCode\" text NULL, \"FnDepositCountDate\" integer NOT NULL DEFAULT 0, \"FnDepositAmount\" numeric NOT NULL DEFAULT 0, \"FnGrtCountDate\" integer NOT NULL DEFAULT 0, \"FnGrtAmount\" numeric NOT NULL DEFAULT 0, \"FnTotalAmount\" numeric NOT NULL DEFAULT 0, \"PDCountDate\" integer NOT NULL DEFAULT 0, \"PDAmount\" numeric NOT NULL DEFAULT 0, \"Status\" text NOT NULL DEFAULT 'Pending', \"Remark\" text NULL, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"LogLUDateTime\" timestamp NULL, \"LogLUBy\" text NULL)",
            "CREATE INDEX IF NOT EXISTS \"IX_FnExpCalcLines_Org_CaNo_Vin\" ON public.\"FnExpCalcLines\" (\"OrgId\", \"CaNo\", \"Vin\")",
            "CREATE INDEX IF NOT EXISTS \"IX_FnExpCalcLines_Org_Vin\" ON public.\"FnExpCalcLines\" (\"OrgId\", \"Vin\")",
            // ===== Mẫu hợp đồng mua bán xe của Đại lý (BizHTC.RetailContract.Dlr_Mst_ContractForm / Dlr_Mst_DealerContractForm) =====
            "CREATE TABLE IF NOT EXISTS public.\"DealerContractForms\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"ContractFNo\" text NOT NULL DEFAULT '', \"ContractFName\" text NOT NULL DEFAULT '', \"ContractFType\" text NULL, \"Remark\" text NULL, \"FlagActive\" text NOT NULL DEFAULT '1', \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"LogLUDateTime\" timestamp NULL, \"LogLUBy\" text NULL)",
            "CREATE UNIQUE INDEX IF NOT EXISTS \"IX_DealerContractForms_Org_ContractFNo\" ON public.\"DealerContractForms\" (\"OrgId\", \"ContractFNo\")",
            "CREATE INDEX IF NOT EXISTS \"IX_DealerContractForms_Org_FlagActive\" ON public.\"DealerContractForms\" (\"OrgId\", \"FlagActive\")",
            "CREATE TABLE IF NOT EXISTS public.\"DealerContractFormTerms\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"DealerCode\" text NOT NULL DEFAULT '', \"ContractFNo\" text NOT NULL DEFAULT '', \"Note\" text NULL, \"Promotion\" text NULL, \"TimePayment\" text NULL, \"MethodPayment\" text NULL, \"TimeAndAddressDelivery\" text NULL, \"TimeOwnerTransfer\" text NULL, \"RightAndResponsibilityPartySeller\" text NULL, \"RightAndResponsibilityPartyBuyer\" text NULL, \"Warrantly\" text NULL, \"OtherTerms\" text NULL, \"Remark\" text NULL, \"FlagActive\" text NOT NULL DEFAULT '1', \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"CreateBy\" text NULL, \"LogLUDateTime\" timestamp NULL, \"LogLUBy\" text NULL)",
            "CREATE UNIQUE INDEX IF NOT EXISTS \"IX_DealerContractFormTerms_Org_Dealer_Form\" ON public.\"DealerContractFormTerms\" (\"OrgId\", \"DealerCode\", \"ContractFNo\")",
            "CREATE INDEX IF NOT EXISTS \"IX_DealerContractFormTerms_Org_Dealer\" ON public.\"DealerContractFormTerms\" (\"OrgId\", \"DealerCode\")",
            "CREATE INDEX IF NOT EXISTS \"IX_DealerContractFormTerms_Org_Form\" ON public.\"DealerContractFormTerms\" (\"OrgId\", \"ContractFNo\")",
            // ===== Biên bản hủy hợp đồng thanh toán qua ngân hàng (BizHTC.DMS40.DMS40_DlrCtr_CancelBankMD) =====
            "ALTER TABLE public.\"DealerContracts\" ADD COLUMN IF NOT EXISTS \"BankCodeMD\" text NULL",
            "CREATE TABLE IF NOT EXISTS public.\"CancelBankMDs\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"CancelBankMDNo\" text NOT NULL DEFAULT '', \"DlrCtrNo\" text NOT NULL DEFAULT '', \"DealerCode\" text NOT NULL DEFAULT '', \"BankCodeMD\" text NULL, \"Status\" text NOT NULL DEFAULT 'P', \"RemarkDlr\" text NULL, \"RemarkBank\" text NULL, \"CreateBy\" text NULL, \"ApproveBy\" text NULL, \"FinishBy\" text NULL, \"CancelBy\" text NULL, \"RejectBy\" text NULL, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"ApproveAt\" timestamp NULL, \"FinishAt\" timestamp NULL, \"CancelAt\" timestamp NULL, \"RejectAt\" timestamp NULL, \"LogLUDateTime\" timestamp NULL, \"LogLUBy\" text NULL)",
            "CREATE UNIQUE INDEX IF NOT EXISTS \"IX_CancelBankMDs_Org_No\" ON public.\"CancelBankMDs\" (\"OrgId\", \"CancelBankMDNo\")",
            "CREATE INDEX IF NOT EXISTS \"IX_CancelBankMDs_Org_DlrCtrNo\" ON public.\"CancelBankMDs\" (\"OrgId\", \"DlrCtrNo\")",
            "CREATE INDEX IF NOT EXISTS \"IX_CancelBankMDs_Org_Dealer\" ON public.\"CancelBankMDs\" (\"OrgId\", \"DealerCode\")",
            "CREATE INDEX IF NOT EXISTS \"IX_CancelBankMDs_Org_Status\" ON public.\"CancelBankMDs\" (\"OrgId\", \"Status\")",
            // ===== Lịch làm việc / Phân công việc nhân sự Đại lý (HCare.idocNet.Biz.Wk_UserSchedule) =====
            "CREATE TABLE IF NOT EXISTS public.\"UserSchedules\" (\"Id\" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"OrgId\" uuid NOT NULL, \"SchCode\" text NOT NULL DEFAULT '', \"UserCodeOwner\" text NOT NULL DEFAULT '', \"KPIPlusCode\" text NULL, \"KPIPlusName\" text NULL, \"SalesID\" text NULL, \"SchLocation\" text NULL, \"EffDTimeStart\" timestamp NULL, \"EffDTimeEnd\" timestamp NULL, \"RankingType\" text NULL, \"LevelType\" text NULL, \"CustomerCode\" text NULL, \"Remark\" text NULL, \"USStatus\" text NOT NULL DEFAULT 'P', \"FileName\" text NULL, \"FilePath\" text NULL, \"CreateBy\" text NULL, \"CreatedAt\" timestamp NOT NULL DEFAULT now(), \"LUDTime\" timestamp NULL, \"LUBy\" text NULL, \"LogLUDateTime\" timestamp NULL, \"LogLUBy\" text NULL)",
            "CREATE UNIQUE INDEX IF NOT EXISTS \"IX_UserSchedules_Org_SchCode\" ON public.\"UserSchedules\" (\"OrgId\", \"SchCode\")",
            "CREATE INDEX IF NOT EXISTS \"IX_UserSchedules_Org_Owner\" ON public.\"UserSchedules\" (\"OrgId\", \"UserCodeOwner\")",
            "CREATE INDEX IF NOT EXISTS \"IX_UserSchedules_Org_Status\" ON public.\"UserSchedules\" (\"OrgId\", \"USStatus\")",
            "CREATE INDEX IF NOT EXISTS \"IX_UserSchedules_Org_Level\" ON public.\"UserSchedules\" (\"OrgId\", \"LevelType\")"
        };
